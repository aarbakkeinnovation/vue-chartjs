...
</code></pre></div><h2 id="updating-charts" tabindex="-1">Updating Charts <a class="header-anchor" href="#updating-charts" aria-hidden="true">#</a></h2><p>vue-chartjs charts have data change watcher by default. vue-chartjs will update or re-render the chart if new data is passed.</p><div class="language-vue"><pre><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span>
...
</code></pre></div><h3 id="options" tabindex="-1">Options <a class="header-anchor" href="#options" aria-hidden="true">#</a></h3><p>The <code>options</code> object is not currently implemented reactively. Therefore, if you dynamically change the chart options, they will not be recognized by the update data handler.</p><h3 id="events" tabindex="-1">Events <a class="header-anchor" href="#events" aria-hidden="true">#</a></h3><p>Charts will emit events if the data changes. You can listen to them in the chart component. The following events are available:</p><ul><li><code>chart:rendered</code> - if the chart object instance rendered</li><li><code>chart:destroyed</code> - if the chart object instance removed</li><li><code>chart:updated</code> - if the update handler performs an update instead of a re-render</li><li><code>labels:updated</code> - if new labels were set</li></ul><h3 id="chartjs-plugin-annotation" tabindex="-1">chartjs-plugin-annotation <a class="header-anchor" href="#chartjs-plugin-annotation" aria-hidden="true">#</a></h3><p>When using <a href="https://www.chartjs.org/chartjs-plugin-annotation/latest/" target="_blank" rel="noopener noreferrer">chartjs-plugin-annotation</a> and <strong>Vue 2</strong> simultaneously, you will not be able to place multiple reactive charts on one page.</p><h2 id="examples" tabindex="-1">Examples <a class="header-anchor" href="#examples" aria-hidden="true">#</a></h2><h3 id="chart-with-props" tabindex="-1">Chart with props <a class="header-anchor" href="#chart-with-props" aria-hidden="true">#</a></h3><p>Your goal should be to create reusable chart components. For this purpose, you should utilize Vue.js props to pass in chart options and chart data. This way, the parent component itself does not hold an opinion about fetching data and is only for presentation.</p><div class="language-vue"><pre><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span>
